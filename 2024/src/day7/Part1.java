...
public class Part1 {
  ...
  public static void main(String[] args) throws IOException {
    ...
    for (String line : input) {
      ...
      equations.add(new CalibrationEquation(expectedTotal, coefficientsList.stream().mapToInt(Integer::intValue).toArray()));
    }
...
//    }
    ...
    for (final CalibrationEquation calibrationEquation : equations) {
      final boolean matchingCombinationFound = calibrationEquation.evaluateCombinations();
